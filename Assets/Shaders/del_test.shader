...
Shader "del test"
{
	Properties
	{
		...
		_transparency("transparency", Range( 0 , 2)) = 1.317647
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			clip( step( _transparency , length( (float2( 14,14 ) + ((ase_screenPosNorm).xy - float2( 12,12 )) * (float2( 15,15 ) - float2( 14,14 )) / (float2( 13,13 ) - float2( 12,12 ))) ) ) - _Cutoff );
		}
...
/*ASEBEGIN
Version=16900
3069;53;1808;935;1127.863;561.6849;1;True;True
...
Node;AmplifyShaderEditor.TFHCRemapNode;3;-483.1954,6.053345;Float;False;5;0;FLOAT2;0,0;False;1;FLOAT2;12,12;False;2;FLOAT2;13,13;False;3;FLOAT2;14,14;False;4;FLOAT2;15,15;False;1;FLOAT2;0
...
WireConnection;45;10;12;0
ASEEND*/
//CHKSM=BFA5BA95C8FF2AFD090323DA183F65B58F72F2B9